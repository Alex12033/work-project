...
mobileFreeBtn.innerHTML = localStorage.getItem('logged') ? `Hi ${localStorage.getItem('user')}` : "Start Free";

authBtn.innerHTML = localStorage.getItem('logged') ? "Logout" : "Sign In";
mobileAuthBtn.innerHTML = localStorage.getItem('logged') ? "Logout" : "Sign In";
